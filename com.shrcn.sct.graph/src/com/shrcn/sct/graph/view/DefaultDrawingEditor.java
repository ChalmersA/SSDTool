...
//	private HashMap<Figure, Object> figMdlMap = new HashMap<Figure, Object>();
    ...
    protected Dimension preferredViewSize;
    ...
    public void toolDone(ToolEvent evt) {
        ...
        DefaultDrawingView v = (DefaultDrawingView)getActiveView();
        if (v != null) {
	...
	@Override
	public Map<Figure, Object> getFigureModelMap() {
		return this.getFigureModelMap();
	}
}
