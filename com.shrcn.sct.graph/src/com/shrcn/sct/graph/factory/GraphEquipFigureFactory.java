 ...
 */
/**
 * $Log: EquipFigureFactory.java,v $ Revision 1.1 2013/07/29 03:50:32 cchun
 * Add:创建
 * 
 * Revision 1.16 2010/09/17 09:25:53 cchun Update:设备图元锚点改用弧度计算
 * 
 * Revision 1.15 2010/09/03 02:55:30 cchun Update;增加母线标签
 * 
 * Revision 1.14 2010/07/06 10:16:19 cchun Update:添加绘制圆弧工具
 * 
 * Revision 1.13 2010/06/29 08:36:52 cchun Refactor:修改包名
 * 
 * Revision 1.12 2010/06/29 02:22:29 cchun Update:去掉重复的BezierFigure
 * 
 * Revision 1.11 2010/06/28 02:05:25 cchun Update:添加电容器、电抗器设备图形
 * 
 * Revision 1.10 2009/10/14 10:39:09 wyh 添加functionFigure图元
 * 
 * Revision 1.9 2009/09/08 04:40:48 cchun Update:添加独立的标签图形类
 * 
 * Revision 1.8 2009/09/03 08:39:19 hqh
 * LineConenctionFigure->ManhttanConenctionFigure
 * 
 * Revision 1.7 2009/09/01 01:28:38 wyh 添加导电线Connector
 * 
 * Revision 1.6 2009/08/31 08:15:59 hqh 修改连接点
 * 
 * Revision 1.5 2009/08/26 03:32:49 wyh 添加：BusbarConnector
 * 
 * Revision 1.4 2009/08/18 07:39:34 cchun Refactor:重构包路径
 * 
 * Revision 1.3 2009/08/18 03:02:33 cchun Update:注册母线、连接点、路由图形的xml处理
 * 
 * Revision 1.2 2009/08/14 08:30:20 cchun Update:增加对设备图元的xml信息处理
 * 
 * Revision 1.1 2009/08/14 03:31:12 cchun Update:创建设备专用图形类
 * 
 * Revision 1.1 2009/08/10 08:51:41 cchun Update:完善设备模板工具类
 * 
 */
public class GraphEquipFigureFactory extends EquipFigureFactory {
    ...
    public GraphEquipFigureFactory() {
