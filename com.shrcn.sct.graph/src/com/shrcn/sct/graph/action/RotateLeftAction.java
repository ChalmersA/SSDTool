 ...
 */
/**
 * $Log: RotateLeftAction.java,v $
 * Revision 1.19  2010/09/21 00:57:43  cchun
 * Refactor:将旋转后设备锚点处理放到EquipmentFigure中
 *
 * Revision 1.18  2010/09/17 06:14:44  cchun
 * Update:设备图元锚点改用弧度计算
 *
 * Revision 1.17  2010/09/07 02:43:08  cchun
 * Update:母线支持旋转
 *
 * Revision 1.16  2010/07/30 00:58:40  cchun
 * Update:添加图元复制后再旋转锚点出错的问题
 *
 * Revision 1.15  2010/02/01 03:14:25  hqh
 * 修改图形旋转
 *
 * Revision 1.14  2010/01/29 05:00:49  cchun
 * Update:使用更规范的常量引用
 *
 * Revision 1.13  2009/09/21 07:33:57  cchun
 * Update:重构旋转代码逻辑
 * Fix Bug:为旋转操作添加修改标记
 *
 * Revision 1.12  2009/09/18 03:52:55  hqh
 * 2卷变压器处理
 *
 ...
 * 修改旋转方法
 * Revision 1.8 2009/08/31 08:14:03 hqh 添加锚点旋转
 * Revision 1.7 2009/08/28 06:48:58 hqh AffineTransform->AffineTransform
 * 
 * Revision 1.6 2009/08/19 04:01:17 hqh 继承旋转action, Revision 1.5 2009/08/18
 * 07:37:40 cchun Refactor:重构包路径
 * 
 ...
 * 
 */
public class RotateLeftAction extends RotateAction {

	private static final long serialVersionUID = 1L;

	public RotateLeftAction(DrawingEditor editor, ResourceBundleUtil labels1) {
		super(editor, labels1);
		labels.configureAction(this, "rotateLeft");
	}

	@Override
	protected AffineTransform getTransform(Figure f) {
		return RotateUtil.getRotateLeft(getCenter(f));
	}
}
